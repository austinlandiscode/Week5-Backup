export class Calculator {
  ...
  checkYears() {
    if (this.planet === 'Mercury') {
      this.planetAge = (Math.floor(this.age / 0.24));
      return this.planetAge;
    } else if (this.planet === 'Venus') {
      this.planetAge = (Math.floor(this.age / 0.62));
      return this.planetAge;
    } else if (this.planet === 'Mars') {
      this.planetAge = (Math.floor(this.age / 1.88));
      return this.planetAge;
    } else if (this.planet === 'Jupiter') {
      this.planetAge = (Math.floor(this.age / 11.86));
      return this.planetAge;
    }
  }
